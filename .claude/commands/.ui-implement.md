...
<implementation_plan>
@docs/web-implementation-plan/group-create-view-implementation-plan.md
</implementation_plan>
...
<types>
@SantaVibe.Web\src\api\model\create-group-request.ts
@SantaVibe.Web\src\api\model\create-group-response.ts
</types>
